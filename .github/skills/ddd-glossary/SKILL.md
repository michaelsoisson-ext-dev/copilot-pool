...
It scans for domain terms, resolves ambiguities, proposes canonical names, and writes a living glossary to `docs/codebase/DOMAIN_GLOSSARY.md` in the working directory.
...
7. **Write or update `DOMAIN_GLOSSARY.md`**
    ...
    - writes a living glossary to `docs/codebase/DOMAIN_GLOSSARY.md` in the working directory.
