...
Copy each template from `references/` into `docs/codebase/`. Fill in this order:

1. [STACK.md](references/STACK.md) — language, runtime, frameworks, all dependencies
2. [STRUCTURE.md](references/STRUCTURE.md) — directory layout, entry points, key files
3. [ARCHITECTURE.md](references/ARCHITECTURE.md) — layers, patterns, data flow
4. [CONVENTIONS.md](references/CONVENTIONS.md) — naming, formatting, error handling, imports
5. [INTEGRATIONS.md](references/INTEGRATIONS.md) — external APIs, databases, auth, monitoring
6. [TESTING.md](references/TESTING.md) — frameworks, file organization, mocking strategy
7. [CONCERNS.md](references/CONCERNS.md) — tech debt, bugs, security risks, perf bottlenecks
...
| [`references/STACK.md`](references/STACK.md) | Phase 3 step 1 |
| [`references/STRUCTURE.md`](references/STRUCTURE.md) | Phase 3 step 2 |
| [`references/ARCHITECTURE.md`](references/ARCHITECTURE.md) | Phase 3 step 3 |
| [`references/CONVENTIONS.md`](references/CONVENTIONS.md) | Phase 3 step 4 |
| [`references/INTEGRATIONS.md`](references/INTEGRATIONS.md) | Phase 3 step 5 |
| [`references/TESTING.md`](references/TESTING.md) | Phase 3 step 6 |
| [`references/CONCERNS.md`](references/CONCERNS.md) | Phase 3 step 7 |
