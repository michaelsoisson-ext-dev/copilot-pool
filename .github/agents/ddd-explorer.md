...
3. Report findings directly as file named `docs/codebase/DOMAIN_CONTEXT.md` and save it following the [checklist](#output-checklist) :
4. Use the skill `ddd-glossary` to generate a domain glossary references file
5. Use the skill `codebase-knowledge` to map this codebase.

6. finally update the `AGENTS.md` file with updated links
